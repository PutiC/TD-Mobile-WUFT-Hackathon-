...
class mainViewController: UINavigationController {
    ...
    func adddeposit(){
        ...
        //deposit
        let layer2 = UIView()
        layer2.frame = CGRect(x: 238, y: 398, width: 89, height: 89)
        layer2.backgroundColor = UIColor(patternImage: UIImage(named: "deposit")!)
        view.addSubview(layer2)
        
        //text
        let textLayer = UILabel()
        textLayer.frame = CGRect(x: 208, y: 521.5, width: 158, height: 34)
        textLayer.lineBreakMode = .byWordWrapping
        textLayer.numberOfLines = 0
        textLayer.textColor = UIColor(red: 0.28, green: 0.32, blue: 0.37, alpha: 1)
        let textContent = "Deposit Checks"
        let textString = NSMutableAttributedString(
            string: textContent,
            attributes: [
    ...
    func addbill(){
        ...
        //bill payment
        let layer2 = UIView()
        layer2.frame = CGRect(x: 47.5, y: 398, width: 89, height: 89)
        layer2.backgroundColor = UIColor(patternImage: UIImage(named: "dollar90")!)
        view.addSubview(layer2)
    ...
    func addtransferfund(){
        ...
        //transfer fund
        let layer2 = UIView()
        layer2.frame = CGRect(x: 232.5, y: 170.5, width: 100, height: 100)
        layer2.backgroundColor = UIColor(patternImage: UIImage(named: "transfer")!)
        view.addSubview(layer2)
    ...
    func addpayafriend(){
        ...
        layer2.backgroundColor = UIColor(patternImage: UIImage(named: "friends")!)
        view.addSubview(layer2)
        
        //text
        let textLayer = UILabel()
        textLayer.frame = CGRect(x: 24.5, y: 299.5, width: 133.5, height: 34)
        textLayer.lineBreakMode = .byWordWrapping
        textLayer.numberOfLines = 0
        textLayer.textColor = UIColor(red: 0.28, green: 0.32, blue: 0.37, alpha: 1)
        let textContent = "Pay A Friend"
        let textString = NSMutableAttributedString(
            string: textContent,
            attributes: [
                NSFontAttributeName: UIFont(name: "avenir", size: 22.5)!
    ...
    func adddashboardtab(){
        let dash = UIButton()
        dash.frame = CGRect(x: 250, y: 83, width: 88.74, height: 18.32)
        ...
        textString.addAttribute(NSKernAttributeName, value: 0, range: textRange)
       // dash.sizeToFit()
        dash.setAttributedTitle(textString, for: UIControlState.normal)
        dash.addTarget(self, action: #selector(gotodash(_:)), for: UIControlEvents.touchUpInside)

        view.addSubview(dash)
    }
    
    func gotodash(_ sender: UIButton) {
        performSegue(withIdentifier: "godash", sender: nil)
    }
    ...
    func addpaymenttab(){
        let layer = UIView()
        layer.frame = CGRect(x: 24.03, y: 78, width: 108.04, height: 29.5)
        layer.backgroundColor = UIColor(red: 0.51, green: 0.56, blue: 0.65, alpha: 1)
        layer.layer.cornerRadius = 4
        view.addSubview(layer)
        
        let textLayer = UILabel()
        textLayer.frame = CGRect(x: 24, y: 82.5, width: 108.99, height: 22.5)
        textLayer.lineBreakMode = .byWordWrapping
        textLayer.numberOfLines = 0
        textLayer.textColor = .white
